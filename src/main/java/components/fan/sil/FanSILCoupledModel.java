 ...
 *
 */
public class FanSILCoupledModel extends CoupledModel {

	private static final long serialVersionUID = 1L;
	public static final String URI = FanSILCoupledModel.class.getSimpleName();

	public FanSILCoupledModel(String uri, TimeUnit simulatedTimeUnit, SimulatorI simulationEngine,
