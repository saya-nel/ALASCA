...
/**
 * The class <code>FridgeStateSILModel</code> defines a simulation model tracking
 * the state changes on a fridge.
 *
 * @author Bello Memmi
 */

@ModelExternalEvents(
        imported = {SetEco.class, SetNormal.class, SetRequestedTemperature.class},
        exported = {SetEco.class, SetNormal.class, SetRequestedTemperature.class}
)
